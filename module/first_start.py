...
from first_process_module import splitProfessor, del_blank, split_time, split_room, editKhuProfessorName, editLectureName, editKaistProfessorName, dropSubjectAndCourse
